package pryercarvs.koykoy200078.myapp.ui;
...
import pryercarvs.koykoy200078.myapp.Constants;
...
public class UIManager {
    ...
    public void changeRecentAppsIcon() {
        Bitmap iconWhite = BitmapFactory.decodeResource(activity.getResources(), R.drawable.slp);
